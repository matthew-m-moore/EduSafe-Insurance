...
namespace EduSafe.ConsoleApp.Components
{
    public static class CommandLineArgumentsProcessor
    {
        ...
        private static string TrimPairsOfQuotes(string argument)
        {
            ...
            {
                var argumentWithSurroundingQuotesTrimmed = argument.Substring(1, argumentLength - 2);
                return argumentWithSurroundingQuotesTrimmed;
            }
